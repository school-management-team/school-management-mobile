...
class assignmentsschoolview extends StatelessWidget {
  const assignmentsschoolview({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => globalTaskCubit,
      child: Scaffold(
        appBar: AppBar(
          toolbarHeight: 64.h,
        ...
        floatingActionButton: AddTaskteacherbutton(),
        floatingActionButtonLocation: FloatingActionButtonLocation.startFloat,
        bottomNavigationBar: BottomnavigatoionTeacher(select: 2),
        backgroundColor: Color(0XFFFFFFFF),
        body: SafeArea(child: assignmentschool()),
      ),
    );
  }
}
