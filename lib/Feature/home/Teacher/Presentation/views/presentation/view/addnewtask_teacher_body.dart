...
class Addnewtaskteacher extends State<addnewtaskteacher> {
  ...
  final TextEditingController classsectioncon = TextEditingController();
  ...
  final TextEditingController gradecont = TextEditingController();
  ...
  void publishtask() {
    final taskData = newtaskmodel(
      title: titlecon.text,
      subject: subjectcon.text,
      grade: gradecont.text,
      description: descriptioncont.text,
      date: datecont.text,
      classsection: classsectioncon.text,
      files: [],
    );
    context.read<NewTaskCubit>().addnewtask(taskData);
  }
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'ادخل المادة التي تدرسها',
                                    hintStyle: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            controller: classsectioncon,
                            decoration: InputDecoration(
                              hintText: 'ادخل الصف والشعبة',
                              hintStyle: TextStyle(
                                color: Color(0xFF44474D).withOpacity(0.5),
                                fontSize: 16.sp,
                              ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'اكتب تفاصيل المهمة والتعليمات للطلاب...',
                              hintStyle: TextStyle(
                                color: Color(0xFF44474D).withOpacity(0.5),
                                fontSize: 16.sp,
                              ),
