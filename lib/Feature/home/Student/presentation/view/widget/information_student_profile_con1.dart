      ...
      ListView(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.only(bottomLeft:Radius.circular(16.sp),bottomRight: Radius.circular(16.sp)
              ,), color: Colors.white,
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        child:
                            ...
                            child: 
                            Text("عرض كامل ", style: TextSt.textstyle14),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("مراسلة", style: TextSt.textstyle14.copyWith(color: Colors.white)),
                            IconButton(
                              icon: Icon(Icons.mail_outline_outlined,color: Colors.white, size: 20.sp),
                              onPressed: () {
                                context.read<ProfileStudentCubit>().triggerContactAction();
                              },
                            ),
                          ],
                        ),
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                context.read<ProfileStudentCubit>().triggerEditingAction();
                              },
                            ),
                          ],
                        ),
