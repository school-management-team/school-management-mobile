...
import 'package:school/Feature/home/Student/Data/Profile/student_profile_repo.dart';
...
class ProfileStudentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(
      ...
      create: (context) => ProfileStudentCubit(StudentProfileRepoImpl()),child: 
        SafeArea(child: ProfileStudentBodyView()),
      ),
    );
  }
}
